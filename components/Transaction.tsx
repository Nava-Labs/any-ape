...
import { encodeCounter, encodeInputDataCrossChainSale } from "@/lib/utils";
...
export function Transaction({
  ...
  function TransactionButton({
    ...
    return (
      <button
        className="mt-1 flex h-11 py-2 px-4 gap-2 flex-none items-center justify-center rounded-lg bg-gray-100 hover:bg-gray-200 text-red-500"
        onClick={async () => await useSendTx(a)}
      >
        {isTransactionLoading ? (
